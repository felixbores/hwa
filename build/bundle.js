var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-12x3y6d");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-12x3y6d");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*handleStart*/ ctx[3]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			 $$invalidate(2, progress = (totalSeconds - secondsLeft) * 100 / totalSeconds);
    		}
    	};

    	return [secondsLeft, isRunning, progress, handleStart];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	let current;
    	timer = new Timer({});
    	timer.$on("end", /*handleTimerEnd*/ ctx[1]);
    	howto = new HowTo({});
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [audio, handleTimerEnd, audio_1_binding];
    }
